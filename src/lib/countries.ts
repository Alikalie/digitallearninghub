...
// The flag is computed from the ISO code via Unicode regional indicators,
// so we keep the list compact and dependency-free.
...
/** Returns the flag emoji for an ISO alpha-2 country code (e.g. "US" → 🇺🇸). */
